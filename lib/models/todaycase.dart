...
//
//     final summarys = summarysFromJson(jsonString);

import 'dart:convert';

Summarys summarysFromJson(String str) => Summarys.fromJson(json.decode(str));

String summarysToJson(Summarys data) => json.encode(data.toJson());
...
class Summarys {
  ...
  factory Summarys.fromJson(Map<String, dynamic> json) => Summarys(
